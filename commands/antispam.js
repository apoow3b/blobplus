...
module.exports.run = async (client, message, args) => {
  ...
  if(args[0] == 'on') {
    ...
    if(db.get("antispam_" + message.guild.id) === "on") return message.channel.send(`<:bloberror:869118676740239411> **Anti Spam** is already activated.`)
  
    let embed = new Discord.MessageEmbed()
          .setTitle(`Success!`)
      .setFooter(`${client.user.username}`, client.user.avatarURL())
      .setTimestamp()
    .setDescription(`<:blobsuccess:869118676840873994> **Anti Spam** has been activated!`)
    .setColor("00FF00")
    ...
    return message.channel.send(embed)
        ...
        if(db.get("antispam_" + message.guild.id) === "off") return message.channel.send(`<:bloberror:869118676740239411> **Anti Spam** is already deactivated.`)
      
        let embed = new Discord.MessageEmbed()
              .setTitle(`Success!`)
      .setFooter(`${client.user.username}`, client.user.avatarURL())
      .setTimestamp()
        .setDescription(`<:blobsuccess:869118676840873994> **Anti Spam** has been disabled!`)
        .setColor("#00FF00")
        ...
        .setFooter(`${client.user.username}`, client.user.avatarURL())
        .setTimestamp()
        .setDescription(`<:bloberror:869118676740239411> Usage: \`\`\`${config.prefix}antispam <on/off>\`\`\``)
        .setColor("#FF0000")
